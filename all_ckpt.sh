...
NUM_GPUS="${NUM_GPUS:-1}"
MAIN_LOG="${MAIN_LOG:-dump_master.log}"   # shared, tagged log of ALL runs
...
# ----------------------------- checkpoint list ----------------------------
CHECKPOINTS=(
  sweep-fexo-base-db-replay_off-b1
  sweep-fexo-base-db-replay_off-b10
  sweep-fexo-base-db-replay_on-b1
  sweep-fexo-base-db-replay_on-b10
  sweep-fexo-hidden-db-replay_off-b1
  sweep-fexo-hidden-db-replay_off-b10
  sweep-fexo-hidden-db-replay_on-b1
  sweep-fexo-hidden-db-replay_on-b10
  sweep-fexo-tempgain-db-replay_off-b1
  sweep-fexo-tempgain-db-replay_off-b10
  sweep-fexo-tempgain-db-replay_on-b1
  sweep-fexo-tempgain-db-replay_on-b10
  sweep-nitrogen-base-db-replay_off-b1
  sweep-nitrogen-base-db-replay_off-b10
  sweep-nitrogen-base-db-replay_on-b1
  sweep-nitrogen-base-db-replay_on-b10
  sweep-nitrogen-hidden-db-replay_off-b1
  sweep-nitrogen-hidden-db-replay_off-b10
  sweep-nitrogen-hidden-db-replay_on-b1
  sweep-nitrogen-hidden-db-replay_on-b10
  sweep-nitrogen-hidden-revkl-replay_off-b1
  sweep-nitrogen-hidden-revkl-replay_off-b10
  sweep-nitrogen-hidden-rtb-replay_off-b1
  sweep-nitrogen-hidden-rtb-replay_off-b10
  sweep-nitrogen-tempgain-db-replay_off-b1
  #sweep-nitrogen-tempgain-db-replay_off-b10
  #sweep-nitrogen-tempgain-db-replay_on-b1
  #sweep-nitrogen-tempgain-db-replay_on-b10
  sweep-osim-base-db-replay_off-b1
  sweep-osim-base-db-replay_off-b10
  sweep-osim-base-db-replay_on-b1
  sweep-osim-base-db-replay_on-b10
  sweep-osim-base-rtb-replay_off-b1
)
